  ...
  return (
    ...
    >
      <SectionHeader
        ...
        subtitle="EVERY COMPONENT BATTLE-TESTED. EVERY INTEGRATION PRODUCTION-GRADE."
      />
      ...
      <div className="flex flex-col md:flex-row w-full gap-[2px]">
        <FeatureCard
          iconColor="#FFD600"
          title={"TATUM\nSUI RPC"}
          description="ALL ON-CHAIN READS AND WRITES FLOW THROUGH TATUM'S ENTERPRISE-GRADE SUI GATEWAY. FAST, RELIABLE, INDEXED."
          tag="RPC"
          tagColor="#FFD600"
          borderColor="#FFD600"
        />
        <FeatureCard
          iconColor="#FF6B35"
          title={"WALRUS\nSTORAGE"}
          description="INDEX COMPOSITIONS, PRICE SNAPSHOTS, AND DUEL RESULTS — ALL STORED AS IMMUTABLE BLOBS ON WALRUS. PERMANENT, VERIFIABLE."
          tag="STORAGE"
          tagColor="#FF6B35"
          bgColor="#0F0F0F"
          borderColor="#FF6B35"
        ...
        <FeatureCard
          iconColor="#F5F5F0"
          title={"PYTH\nORACLES"}
          description="REAL-TIME CRYPTO PRICES FROM PYTH NETWORK. SUB-SECOND UPDATES. TAMPER-PROOF. THE TRUTH LAYER FOR SETTLEMENT."
          tag="ORACLE"
          tagColor="#888888"
          borderColor="#555555"
        />
