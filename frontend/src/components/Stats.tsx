const stats = [
  { value: "$51B+", label: "PREDICTION MARKET VOLUME", border: true },
  { value: "1.29M", label: "ACTIVE TRADERS", border: true },
  { value: "80%", label: "SECTOR CAGR", border: true },
  { value: "2%", label: "PLATFORM FEE", border: false },
];
